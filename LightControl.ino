...
char DataStreams1[] = "LIGHT";                // 数据流 LIGHT -- Stream "LIGHT"
char DataStreams2[] = "ServoSwitch"; 
...
int stream;//用于存放返回"ServoSwitch"的数值
...
void loop() 
{
    ...
    stream=readData(DeviceId, DataStreams2);
    Serial.print("stream=");
    Serial.println(stream);
    myservo.write(stream1);
